...
export default function HR() {
  ...
  // function: get nurse list reponse 요청 처리 //
    ...
    <div id='hr-wrapper'>
      ...
      <div className='main'>
        ...
        <div className='table'>
          <div className='th'>
            <div className='td-nurse-infoes'>
              <div className='td-nurse-id'>요양자 ID</div>
              <div className='td-nurse-name'>요양사 이름</div>
              <div className='td-nurse-tel'>요양사 전화번호</div>
            </div>
            <div className='td-buttons'>
