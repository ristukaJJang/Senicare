...
import { ACCESS_TOKEN, CS_ABSOLUTE_WRITE_PATH, CS_DETAIL_ABSOLUTE_PATH, CS_UPDATE_ABSOLUTE_PATH, CS_WRITE_PATH } from 'src/constants';
...
interface TablowRowProps {
    customer: Customer;
    getCustomerList: () => void;
}

// component: 고객 리스트 아이템 컴포넌트 //
function TableRow({customer, getCustomerList}: TablowRowProps) {
...
export default function CS() {
    ...
    const onPostButtonClickHandler = () => {
        navigator(CS_ABSOLUTE_WRITE_PATH);
    }
    ...
    // effect: component load시에 고객 리스트 불러오기 함수 //
