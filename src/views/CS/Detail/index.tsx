...
export default function CSDetail() {
    ...
    const postCareRecordResponse = (responseBody: ResponseDto | null) => {
        ...
        if(!customerNumber || !accessToken) return;
    ...
    const onRecordButtonClickHandler = () => {
        ...
        const accessToken = cookies[ACCESS_TOKEN];
        if(!accessToken || !customerNumber) return;
                ...
                <div className='middle'>
                    ...
                    <div className='main'>
                        ...
                        <div className='th'>
                            ...
                            <div className='td-used-too-count'>개수</div>
                        </div>
                        {viewList.map((careRecord, index) => 
                            <div key={index} className='tr'>
                                <div className='td-record-date'>{changeDateFormat(careRecord.recordDate)}</div>
                                <div className='td-record-contents' style={{textAlign:'left'}}>{careRecord.contents}</div>
                                <div className='td-used-tool'>{careRecord.usedToolName}</div>
                                <div className='td-used-too-count'>{careRecord.count}</div>
                            </div>
                        )}
                        </div>
                    </div>
